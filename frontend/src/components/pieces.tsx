/**
 * SVG chess pieces (Colin M.L. Burnett's set, as used by Wikipedia and
 * lichess). Keyed by FEN character: uppercase = white, lowercase = black.
 */
...
const whiteKing = (
  <g fill="none" {...STROKE}>
    ...
    />
    <path
      d="M12.5 37c5.5 3.5 14.5 3.5 20 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16 4V27v-3.5c-2.5-7.5-12-10.5-16-4-3 6 5 10 5 10V37z"
      fill="#fff"
    />
...
const blackKing = (
  <g fill="none" {...STROKE}>
    ...
    <path
      d="M32 29.5s8.5-4 6.03-9.65C34.15 14 25 18 22.5 24.5l.01 2.1-.01-2.1C20 18 9.906 14 6.997 19.85c-2.497 5.65 4.853 9 4.853 9M12.5 30c5.5-3 14.5-3 20 0m-20 3.5c5.5-3 14.5-3 20 0m-20 3.5c5.5-3 14.5-3 20 0"
      stroke="#fff"
    />
  </g>
);
...
const bishop = (fill: string, detailStroke: string) => (
  <g fill="none" {...STROKE}>
...
const blackKnight = (
  <g fill="none" {...STROKE}>
    ...
    />
    <path
      d="M24.55 10.4l-.45 1.45.5.15c3.15 1 5.65 2.49 7.9 6.75s3.25 10.31 2.75 20.25l-.05.5h2.25l.05-.5c.5-10.06-.88-16.85-3.25-21.34-2.37-4.49-5.79-6.64-9.19-7.16l-.51-.1z"
      fill="#fff"
      stroke="none"
    />
  </g>
...
const PIECE_ART: Record<string, ReactElement> = {
  K: whiteKing,
  Q: whiteQueen,
  R: whiteRook,
  B: bishop("#fff", "#000"),
...
export function isPieceChar(char: string): boolean {
  return char in PIECE_ART;
}
...
export function Piece({ piece }: { piece: string }) {
  ...
  if (!art) return null;
  return (
    <svg className="board__piece" viewBox="0 0 45 45" aria-hidden="true">
      {art}
    </svg>
  );
}
